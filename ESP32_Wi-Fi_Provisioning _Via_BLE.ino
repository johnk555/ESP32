...
You connect to the ESP32 via BLE. On the Wi-Fi provisioning app, you enter and send the SSID 
and password of the network you want your ESP32 to connect to.
Finally, the ESP32 connects to the network using the provided credentials. From this moment,
it can do any other Wi-Fi-related tasks it needs. */

/* To connect and send the credentials to the ESP32 via BLE, we’ll use the Wi-Fi Provisioning App for iOS */
...
/* If you see an Error like this: “Sketch too big” during the uploading process, in Arduino IDE go to 
Tools > Partition scheme > choose anything that has more than 1.4MB APP, for example: 
